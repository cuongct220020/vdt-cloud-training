...
This exercise simplifies things down to a handful of codons so you can focus on the mechanics of translating a sequence into a protein rather than memorizing biology.

## Instructions

Your job is to translate RNA sequences into proteins.

For this exercise, you'll only use a few of the possible 64 codons. They are listed below:
